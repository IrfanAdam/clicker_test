...
export const EDGES = [
  {"from":"dom","to":"init","kind":"flow","label":"DOMContentLoaded"},
  {"from":"init","to":"initShop","kind":"call"},
  {"from":"init","to":"initGame","kind":"call"},
  {"from":"init","to":"initSound","kind":"call"},
  {"from":"initGame","to":"click","kind":"bind","label":"btn.onclick"},
  {"from":"initGame","to":"tick","kind":"bind","label":"setInterval 1s"},
  {"from":"initGame","to":"event","kind":"event","label":"on score:changed"},
  ...
  {"from":"click","to":"state","kind":"read","label":"read streak/power"},
  {"from":"tick","to":"state","kind":"read","label":"read autoClickers"},
  {"from":"tick","to":"addScore","kind":"call"},
  {"from":"addScore","to":"audioMgr","kind":"call","label":"play score"},
  {"from":"addScore","to":"event","kind":"event","label":"dispatch"},
  {"from":"event","to":"updateUI","kind":"event"},
  {"from":"updateUI","to":"refresh","kind":"call"},
  {"from":"updateUI","to":"statStrip","kind":"call"},
  {"from":"updateUI","to":"state","kind":"read"},
  {"from":"handleBuy","to":"getCost","kind":"call"},
  {"from":"handleBuy","to":"state","kind":"read"},
  {"from":"handleBuy","to":"state","kind":"write","label":"deduct + owned"},
  ...
  {"from":"handleBuy","to":"event","kind":"event","label":"dispatch"},
  {"from":"refresh","to":"getCost","kind":"call"},
  {"from":"refresh","to":"state","kind":"read"},
  {"from":"audioMgr","to":"sounds","kind":"call"},
  {"from":"initShop","to":"shopCfg","kind":"read"},
  {"from":"initShop","to":"refresh","kind":"call"},
  {"from":"initShop","to":"handleBuy","kind":"bind","label":"btn.onclick"},
  {"from":"statStrip","to":"state","kind":"read","label":"score / streak"}
];
export const KINDS = {
  "entry": {
    "label": "Entry / Events",
